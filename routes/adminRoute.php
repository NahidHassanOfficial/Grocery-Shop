...
//auth
Route::view('/admin/login', 'components.back-end.auth.login')->name('admin.loginPage');
Route::post('/admin/login', [AdminUserController::class, 'login'])->name('admin.login');
Route::get('/admin/logout', [AdminUserController::class, 'userLogout'])->name('admin.logout');

//views admin account info
Route::middleware([AdminAuthMiddleware::class])->group(function () {
    Route::view('/dashboard', 'components.back-end.summary')->name('dashboard');
