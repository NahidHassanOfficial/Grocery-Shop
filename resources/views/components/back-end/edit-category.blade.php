                         ...
                         <div class="col-lg-12 col-12">
                             ...
                             <div class="card mb-6 shadow border-0">
                                 ...
                                 <form enctype="multipart/form-data" method="POST"
                                     action="{{ route('dash.category.edit') }}" class="card-body p-6" id="form">
                                     @csrf
                                     ...
                                     <div class="row">
                                         ...
                                         <div class="mb-3 col-lg-6">
                                             ...
                                             <input type="text" class="form-control" name="slug"
                                                 placeholder="Slug" id="attachment" value="{{ $category->slug }}"
                                                 required />
                                         </div>
                                         <!-- input -->
                                         ...
                                         <div class="mb-3 col-lg-12 mt-5">
                                             ...
                                             <div class="mb-3">
                                                 ...
                                                 <input type="text" class="form-control" name="meta_title"
                                                     placeholder="Title" value="{{ $category->meta_title }}" />
                                             </div>

                                             <!-- input -->
                                             <div class="mb-3">
                                                 <label class="form-label">Meta Description</label>
                                                 <textarea class="form-control" rows="3" name="meta_desc" placeholder="Meta Description">{{ $category->meta_description }}</textarea>
                                             </div>
                                         </div>
                                         <div class="col-lg-12">
