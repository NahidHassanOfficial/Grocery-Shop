                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-lg-12 mt-5">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" placeholder="Enter Meta Description" name="meta_description">{{ $product->meta_description }}</textarea>
