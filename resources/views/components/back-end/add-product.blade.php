            ...
            <div class="row mb-8">
                <div class="col-md-12">
                    <div class="d-md-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <a href="{{ URL::previous() }}" class="btn btn-light">Back to Product</a>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-lg-6">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="colors[]"
                                                ...
                                                {{ in_array('Red', old('colors', [])) ? 'checked' : '' }}>
                                    ...
                                    <div class="mb-3 col-lg-6">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="size[]"
                                                value="Small" id="sizeSmall"
                                                {{ in_array('Small', old('size', [])) ? 'checked' : '' }}>
                                            <label class="form-check-label" for="sizeSmall">Small</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="size[]"
                                                value="Medium" id="sizeMedium"
                                                {{ in_array('Medium', old('size', [])) ? 'checked' : '' }}>
                                            <label class="form-check-label" for="sizeMedium">Medium</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="size[]"
                                                value="Large" id="sizeLarge"
                                                {{ in_array('Large', old('size', [])) ? 'checked' : '' }}>
                                    ...
                                    <div class="mb-3 col-lg-12 mt-5">
                                        ...
                                        <label for="attachment"
                                            ...
                                            <img src="{{ asset('images/cloud-upload-svgrepo.svg') }}" class="w-25"
                                                alt="">
                                    ...
                                    <div class="mb-3 col-lg-12 mt-5">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" placeholder="Enter Meta Description" name="meta_description">{{ old('meta_description') }}</textarea>
