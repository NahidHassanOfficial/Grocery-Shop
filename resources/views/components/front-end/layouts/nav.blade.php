                ...
                <div class="col-6 text-end d-none d-md-block">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a class="dropdown-item " href="#"><span class="me-2">
            ...
            <div class="row w-100 align-items-center g-3">
                <div class="col-xxl-2 col-lg-3">
                    <a class="navbar-brand d-none d-lg-block" href="{{ route('index') }}">
                        <img src="{{ asset('images/freshcart-logo.svg') }}" alt="eCommerce HTML Template">
                        ...
                        <div class="d-flex align-items-center lh-1">
                            ...
                            <div class="list-inline me-2">
                                <div class="list-inline-item">
                                    ...
                                    <a @if ($isAuth) href="{{ route('profile') }}" @endif
                                        class="text-muted"
                                        @if (!$isAuth) data-bs-toggle="modal" data-bs-target="#loginModal" @endif>
                ...
                <div class="col-md-2 col-xxl-1 text-end d-none d-lg-block">
                    ...
                    <div class="list-inline">
                        <div class="list-inline-item">
                            ...
                            <a href="{{ route('profile.wish-list') }}" class="text-muted position-relative">
        ...
        <div class="container px-0 px-md-3">
            ...
            <div class="offcanvas offcanvas-start p-4 p-lg-0" id="navbar-default">
                ...
                <div class="d-flex justify-content-between align-items-center mb-2 d-block d-lg-none">
                    <div><img src="{{ asset('images/freshcart-logo.svg') }}" alt="eCommerce HTML Template"></div>
                            ...
                            <div class="row p-2 p-lg-4">
                                ...
                                <div class="col-lg-3 col-12 mb-4 mb-lg-0">
                                    <div class="card border-0">
                                        <img src="{{ asset('images/menu-banner.jpg') }}" alt="eCommerce HTML Template"
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="dropdown-submenu ">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item" href="#">Exotics & Premium</a></li>
                                    <li><a class="dropdown-item" href="#">Fresh Sprouts</a></li>
                                    <li><a class="dropdown-item" href="#">Frozen Veg</a></li>
...
<x-front-end.modals.cart></x-front-end.modals.cart>
<x-front-end.modals.location></x-front-end.modals.location>
<x-front-end.modals.login></x-front-end.modals.login>
{{-- <x-front-end.modals.signup></x-front-end.modals.signup> --}}
