     ...
     <main>
                 ...
                 <div class="row">
                     ...
                     <div class="col-md-7 col-xl-6">
                         <div class="ps-lg-10 mt-6 mt-md-0">
                             <!-- content -->
                             <a href="{{ route('category.view', $product->categorySlug) }}"
                             ...
                             <div>
                                 ...
                                 <div class="input-group input-spinner">
                                     <input type="button" value="-" class="button-minus btn btn-sm"
                                         data-field="quantity" />
                                     <input id="quantity" type="number" step="1" max="10" value="1"
                             ...
                             <div class="mt-3 row justify-content-start g-2 align-items-center">
                                 ...
                                 <div class="col-md-4 col-4">
                                     ...
                                     <a class="btn btn-light" onclick="addProductWishList({{ $product->id }})"
         ...
         <script>
             async function addProductCart(productID) {
                 let response = await axios.post('http://127.0.0.1:8000/profile/add-cart-item', {
                     productID: productID,
             ...
             async function addProductWishList(productID) {
                 let response = await axios.post('http://127.0.0.1:8000/product/wish-list', {
                     productID: productID
                 })
                 if (response.data['status'] === 'success') {
                                 ...
                                 <div class="my-8">
                                     <div class="mb-5">
                                         ...
                                         <p class="mb-0">
                                             ...
                                             magnis eu nisi nunc
                                             sit. Vel, varius habitant ornare ac rhoncus. Consequat risus facilisis ante
                                             ipsum netus risus adipiscing sagittis sed. Lorem ipsum dolor sit amet,
                                             consectetur
                                             adipiscing elit.
                                         </p>
                                     </div>
                                     <div class="mb-5">
                                         ...
                                         <p class="mb-0">
                                             ...
                                             varius sed magnis eu nisi nunc sit. Vel, varius habitant ornare ac rhoncus.
                                             Consequat risus
                                             facilisis ante ipsum netus risus adipiscing sagittis sed.Lorem ipsum dolor
                                                 ...
                                                 <div class="d-flex border-bottom pb-6 mb-6 pt-4">
                                                     ...
                                                     <div class="ms-5">
                                                         ...
                                                         <p>Everytime i ordered from fresh i got greenish yellow bananas
                                                             just like i wanted so go for it , its happens very rare
                                                             that u get over riped ones.</p>
                         ...
                         <div class="col-6 col-sm-6 col-md-3">
                             ...
                             <ul class="nav flex-column">
                                 ...
                                 <li class="nav-item mb-2"><a href="../pages/shop-checkout.html"
                                         class="nav-link">Shop Checkout</a></li>
                             </ul>
                         </div>
                         <div class="col-6 col-sm-6 col-md-3">
